...
?>
	...
	<div class="modal hide fade" id="getStartedDialog">
		...
		<div class="modal-footer">
			<button id="okButton" data-dismiss="modal" class="btn btn-primary">Fechar</button>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="hero-unit">
			<h1>Laudo &Aacute;gil <i class="icon-thumbs-up"></i></h1>
			<p></p>
			<p>Esta aplica&ccedil;&atilde;o foi desenvolvida com o objetivo de ser um ponto de partida para a elabora&ccedil;&atilde;o de laudos &agrave; dist&acirc;ncia. Permitindo ao cliente concentrar-se exclusivamente na funcionalidade eletr&ocirc;nica, o que torna o seu processo de elabora&ccedil;&atilde;o de laudo exclusivamente digitalizado, eliminando processos manuais e repetitivos.</p>
			<p><b>Clique abaixo para mais informa&ccedil;&otilde;es sobre como esta tecnologia pode auxiliar o seu processo de elabora&ccedil;&atilde;o de laudos.</b></p>			
