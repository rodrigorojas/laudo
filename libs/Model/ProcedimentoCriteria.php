...
require_once("DAO/ProcedimentoCriteriaDAO.php");

/**
 * The ProcedimentoCriteria class extends ProcedimentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProcedimentoCriteria extends ProcedimentoCriteriaDAO
{
