...
require_once("DAO/SituacaoExameCriteriaDAO.php");

/**
 * The SituacaoExameCriteria class extends SituacaoExameDAOCriteria and is used
 ...
 * @version 1.0
 */
class SituacaoExameCriteria extends SituacaoExameCriteriaDAO
{
