...
require_once("DAO/DigitadorCriteriaDAO.php");

/**
 * The DigitadorCriteria class extends DigitadorDAOCriteria and is used
 ...
 * @version 1.0
 */
class DigitadorCriteria extends DigitadorCriteriaDAO
{
