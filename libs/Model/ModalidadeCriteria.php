...
require_once("DAO/ModalidadeCriteriaDAO.php");

/**
 * The ModalidadeCriteria class extends ModalidadeDAOCriteria and is used
 ...
 * @version 1.0
 */
class ModalidadeCriteria extends ModalidadeCriteriaDAO
{
