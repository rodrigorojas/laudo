...
require_once("DAO/SituacaoLaudoCriteriaDAO.php");

/**
 * The SituacaoLaudoCriteria class extends SituacaoLaudoDAOCriteria and is used
 ...
 * @version 1.0
 */
class SituacaoLaudoCriteria extends SituacaoLaudoCriteriaDAO
{
